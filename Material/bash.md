...
description: Guia introductoria a Bash y scripting.
---
...
- **1977 - Bourne Shell (sh)**: Stephen Bourne, en Bell Labs, crea el Bourne Shell (sh). Fue revolucionario: introdujo scripting, variables, estructuras de control. Se convirtió en el estándar de Unix.
- **1978 - C Shell (csh)**: Bill Joy (creador de vi y co-fundador de Sun) crea el C Shell en Berkeley. Sintaxis parecida a C, pero incompatible con sh.
- **1983 - Korn Shell (ksh)**: David Korn mejora el Bourne Shell con características de csh. Muy usado en entornos comerciales Unix.
- **1989 - Bash**: Brian Fox, trabajando para el proyecto GNU de Richard Stallman, crea Bash. El nombre es un juego de palabras brillante:

"Bourne Again Shell" suena igual que "Born Again Shell" (shell renacido)

Es un doble significado:

- Literal: Es el shell Bourne "otra vez" — un sucesor compatible con sh
- Juego de palabras: Es un shell "renacido" — como "born again" en inglés (volver a nacer)
