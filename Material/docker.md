...
description: Introduccion a Docker, componentes y Docker Compose.
---
...
- [¿Para qué usar Docker?](#para-qué-usar-docker)
- [Beneficios principales](#beneficios-principales)
- [Componentes clave de Docker](#componentes-clave-de-docker)
- [Diferencia entre imagen y contenedor](#diferencia-entre-imagen-y-contenedor)
- [Qué necesito para usar Docker](#qué-necesito-para-usar-docker)
- [Docker Compose](#docker-compose)
- [Características principales](#características-principales)
- [Comandos básicos](#comandos-básicos)
- [Ejemplo básico de archivo docker-compose.yml](#ejemplo-básico-de-archivo-docker-composeyml)
- [Docker avanzado](#docker-avanzado)
- [Volúmenes y bind mounts](#volúmenes-y-bind-mounts)
- [Redes personalizadas](#redes-personalizadas)
- [Variables de entorno y .env](#variables-de-entorno-y-env)
